...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto flex h-16 items-end gap-[1.6rem] rounded-2xl sm:!border-x-2  !border-sky-600 px-3 pb-[20px] sm:flex bg-black   ", 
        className
      )}>
      {items.map((item) => (
...
function IconContainer({
  ...
  let target=''
  if (title === "Resume" || title === "LinkedIn" || title === "GitHub") {
    target="_blank"
  }
  return (
